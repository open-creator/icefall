...
path = "data/fbank/gigaspeech_cuts_M_fbank.jsonl.gz"
disc_path = "data/fbank/gigaspeech_cuts_M.jsonl.gz"
transform_path = "data/fbank/gigaspeech_cuts_M_fbank_disc_p.jsonl.gz"

# path = "data/fbank/gigaspeech_cuts_DEV_fbank.jsonl.gz"
# disc_path = "data/fbank/gigaspeech_cuts_DEV.jsonl.gz"
# transform_path = "data/fbank/gigaspeech_cuts_DEV_fbank_disc_p.jsonl.gz"

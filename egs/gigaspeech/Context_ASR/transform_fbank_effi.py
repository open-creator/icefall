...
# path = "data/fbank/gigaspeech_cuts_M-sp0_9_fbank.jsonl.gz"
# disc_path = "data/fbank/gigaspeech_cuts_M-sp0_9.jsonl.gz"
# transform_path = "data/fbank/gigaspeech_cuts_M-sp0_9_fbank_disc_p.jsonl.gz"

path = "data/fbank/gigaspeech_cuts_TEST_fbank.jsonl.gz"
disc_path = "data/fbank/gigaspeech_cuts_TEST.jsonl.gz"
transform_path = "data/fbank/gigaspeech_cuts_TEST_fbank_disc_p.jsonl.gz"
